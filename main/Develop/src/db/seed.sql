...
BEGIN
    ...
    INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Priya', 'Pechi', var_role_id, NULL) RETURNING id INTO var_emp_id;
    ...
    INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Anshu', 'Shivu', var_role_id, NULL) RETURNING id INTO var_emp_id;
    ...
    INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('Siddha', 'Rishi', var_role_id, NULL) RETURNING id INTO var_emp_id;
